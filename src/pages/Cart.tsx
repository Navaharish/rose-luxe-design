...
export default function Cart() {
  const cartItems = [
    { id: "1", name: "Vitamin C Serum", price: 35, quantity: 1, image: vitaminCSerum, variant: "30ml" },
    { id: "2", name: "Natural Beetroot Lip Balm", price: 12, quantity: 2, image: beetrootLipbalm, variant: "8g" }
  ];
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between mt-4">
                          <div className="flex items-center border border-border rounded-full">
                            <Button variant="ghost" size="icon" className="rounded-l-full h-8 w-8">
                              <Minus className="h-3 w-3" />
                            </Button>
                            <span className="w-10 text-center text-sm font-medium">
                              {item.quantity}
                            </span>
                            <Button variant="ghost" size="icon" className="rounded-r-full h-8 w-8">
